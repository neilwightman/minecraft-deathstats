...
public final class ConfigScreen extends Screen {
    ...
    public ConfigScreen(final Screen parentScreen) {
        super(new TextComponent("Configuration"));  // TODO //new TranslatableComponent()
    ...
    protected void init() {
        ...
        CycleOption<Boolean> booleanValue = CycleOption.createOnOff("options.rawMouseInput", (option) -> {
            return true;
        }, (opt1, opt2, value) -> {
            System.out.println("Setting " + opt1 + " " + opt2 + " " + value);
        });

        optionsList.addBig(booleanValue);
        ...
        info = new Button(
                ...
                new TranslatableComponent("deathstats.configGui.moreInfo"),
    ...
    public void render(PoseStack pose, int mouseX, int mouseY, float partialTick) {
        ...
        optionsList.render(pose, mouseX, mouseY, partialTick);

        info.render(pose, mouseX, mouseY, partialTick);
        
        done.render(pose, mouseX, mouseY, partialTick);

        drawCenteredString(pose, this.font, this.title.getString(),
